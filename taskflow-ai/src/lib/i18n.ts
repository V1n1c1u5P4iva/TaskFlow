...
export const genderOptions: Record<Language, Array<{value: string, label: string}>> = {
  ...
  es: [
    ...
    { value: "prefiro-nao-dizer", label: "Prefiero no decir" },
  ],
  en: [
    { value: "masculino", label: "Male" },
    { value: "feminino", label: "Female" },
    { value: "outro", label: "Other" },
    { value: "prefiro-nao-dizer", label: "Prefer not to say" },
  ],
};
...
export const occupationOptions: Record<Language, Array<{value: string, label: string}>> = {
  pt: [
    ...
    { value: "trabalhador", label: "Trabalhador(a)" },
    { value: "ambos", label: "Estudante e Trabalhador(a)" },
    { value: "outro", label: "Outro" },
  ],
  es: [
    { value: "estudante", label: "Estudiante" },
    { value: "trabalhador", label: "Trabajador(a)" },
    { value: "ambos", label: "Estudiante y Trabajador(a)" },
    { value: "outro", label: "Otro" },
  ],
  en: [
    { value: "estudante", label: "Student" },
    { value: "trabalhador", label: "Worker" },
    { value: "ambos", label: "Student & Worker" },
    { value: "outro", label: "Other" },
  ],
};
